...
{
    [ApiController]
    [Route("marcasValvulas")]
    public class MarcasValvulasController
    {
        ...
        {
            DataSet marcasMotores = DBDatos.ListarTablas("sp_getAllMarcasValvulas");
        ...
        [HttpPost]
        [Route("postMarca")]
        public dynamic postCompany([FromBody] MarcasValvulas marcaMotor)
        {
            ...
            bool queryExecuted = DBDatos.Ejecutar("sp_insertIntoMarcasValvulas", parameters);
